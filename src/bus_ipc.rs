...
pub fn event_type_name(event: &BusEvent) -> &'static str {
    match event {
        BusEvent::AnchorExtracted(_) => "AnchorExtracted",
        BusEvent::AnchorCacheHit(_) => "AnchorCacheHit",
        BusEvent::AnchorCacheMiss(_) => "AnchorCacheMiss",
        BusEvent::LosslessConfirmed(_) => "LosslessConfirmed",
        BusEvent::RuntimeSignalFrame(_) => "RuntimeSignalFrame",
        BusEvent::RuntimeAnomalyDetected(_) => "RuntimeAnomalyDetected",
        BusEvent::RuntimeOptimizationAvailable(_) => "RuntimeOptimizationAvailable",
        BusEvent::ProcessStarted(_) => "ProcessStarted",
        BusEvent::ProcessEnded(_) => "ProcessEnded",
        BusEvent::LanguageAnchorExtracted(_) => "LanguageAnchorExtracted",
        BusEvent::SemanticClusterFormed(_) => "SemanticClusterFormed",
        BusEvent::VaultGapDetectedByLanguage(_) => "VaultGapDetectedByLanguage",
        BusEvent::VaultGapDetected(_) => "VaultGapDetected",
        BusEvent::CrawlCompleted(_) => "CrawlCompleted",
        BusEvent::FileRequestGenerated(_) => "FileRequestGenerated",
        BusEvent::GapFilled(_) => "GapFilled",
        BusEvent::VaultWrite(_) => "VaultWrite",
        BusEvent::VaultSync(_) => "VaultSync",
        BusEvent::TrustScoreUpdated(_) => "TrustScoreUpdated",
        BusEvent::ObservationEngineBlock(_) => "ObservationEngineBlock",
        BusEvent::ObservationEngineLearn(_) => "ObservationEngineLearn",
        BusEvent::VramPressureChanged(_) => "VramPressureChanged",
        BusEvent::TextureUploadRequested(_) => "TextureUploadRequested",
        BusEvent::TextureUploadCompleted(_) => "TextureUploadCompleted",
        BusEvent::MediaTraceRecorded(_) => "MediaTraceRecorded",
        BusEvent::ShaderCompileRequested(_) => "ShaderCompileRequested",
        ...
        BusEvent::VramEvictionRequired(_) => "VramEvictionRequired",
        BusEvent::FrameStarted(_) => "FrameStarted",
        BusEvent::FrameCompleted(_) => "FrameCompleted",
        BusEvent::FrameDropDetected(_) => "FrameDropDetected",
        BusEvent::RenderBottleneckDetected(_) => "RenderBottleneckDetected",
        BusEvent::WorkflowAnchorHit(_) => "WorkflowAnchorHit",
        BusEvent::WorkflowAnchorLearned(_) => "WorkflowAnchorLearned",
        BusEvent::WorkflowOptimizationExecuted(_) => "WorkflowOptimizationExecuted",
