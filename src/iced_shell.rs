            ...
            row![
                column![
                    ...
                    text(match self.active_tab {
                        ...
                        Tab::Control => "Steuerzentrale: Checks starten, System stabilisieren, Fehler beheben — alles auf einen Blick.",
                        ...
                        Tab::Privacy => "Datenschutz: festlegen wer welche Daten sieht, wie lange sie gespeichert bleiben und was geschwärzt wird.",
                        Tab::Chat => "Chat: Fragen stellen, Abläufe steuern und Nachrichten mit anderen lokalen Nutzern austauschen.",
                        Tab::Browser => "Browser: eingebetteter Web-Browser für sichere Recherche direkt in Aether — ohne externen Browser.",
                        Tab::YouTube => "YouTube: Videos laden und gleichzeitig strukturell analysieren. KI-Mustererkennung läuft im Hintergrund.",
                        Tab::Data => "Daten: Dateien ablegen, analysieren und als Artefakte sichern — hier landen alle Analyse-Ergebnisse.",
                        Tab::Settings => "Einstellungen: Laufzeit-Profil wählen (Legacy für ältere Hardware), Takt und Bridge-Verbindungen konfigurieren.",
                        Tab::Logs => "Protokoll: alle Ereignisse, Fehler und Sicherheitsmeldungen chronologisch — der Blick hinter die Kulissen.",
                        Tab::Anchors => "Anker: unveränderliche Strukturpunkte anzeigen, die beweisen dass Daten nicht manipuliert wurden.",
                        Tab::FlowSphere => "FlowSphere: 3D-Musterbild — zeigt Zusammenhänge, Ausreißer und Stabilität des Gesamtbilds.",
                        Tab::StructureMap => "Strukturkarte: Delta-Konvergenz und Kompressionspfad — wie stark haben sich Daten verändert, wie gut lassen sie sich rekonstruieren.",
                        Tab::Gaming => "Gaming-Welt: misst wie viel Aether über interaktive Muster gelernt hat und wann ein stabiler Rollout sinnvoll ist.",
                        Tab::Media => "Medien-Welt: Sequenzen, Videos und Audio werden offline verdichtet — je mehr Material, desto besser die Modelle.",
                        Tab::Research => "Forschungs-Welt: Messdaten und Archive rückwirkend verknüpfen und reproduzierbar machen.",
                        Tab::ADE => "Bedrohungsanalyse: Dateien auf Malware, Obfuskation und Anomalien prüfen — mit erklärbaren Ergebnissen.",
                        ...
                        Tab::Launcher => "Launcher: Dienste starten und stoppen, Build-Aufgaben ausführen und Live-Logs beobachten.",
                    }).size(12).color(c(TEXT_M())),
                ]
                .spacing(3),
                container(
