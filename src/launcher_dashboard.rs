...
// ============================================================================
// Centralized dashboard for all Aether services (Symbiont, Dropper, Rust-UI, 
    ...
    pub fn new() -> Self {
        ...
        services.insert(
            ...
            ServiceInfo {
                ...
                name: "AetherDropper GUI".to_string(),
                description: "Python Tkinter GUI for file analysis & anchoring".to_string(),
                status: ServiceStatus::Idle,
                process_id: None,
                last_error: String::new(),
                uptime_secs: 0,
