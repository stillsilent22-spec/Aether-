...
def is_private_context(source: str, content_hint: str) -> bool:
    _private_keywords = (
        "chat","dm","direct_message","message","messenger","groupchat",
        "group_chat","group_message","channel_message","whatsapp","telegram",
        "signal_app","discord_dm","slack_dm","teams_chat","sms","mms",
        "imessage","facetime","skype","viber",
